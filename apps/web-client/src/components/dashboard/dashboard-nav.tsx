...
import {
  Award, BookOpen, LayoutDashboard, Loader2 as Loader2Icon, MessageSquare,
} from 'lucide-react';
...
export function DashboardNav({ activeTab }: DashboardNavProps) {
  ...
  // Xac dinh active tab tu pathname
  ...
  return (
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-30 hidden md:block" onClick={() => setMobileOpen(false)} />
      )}
    </>
  );
}
